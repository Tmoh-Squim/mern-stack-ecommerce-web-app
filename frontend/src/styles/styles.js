const styles = {
    ...
    section:'800px:w-11/12 w-[95%] 800px:mx-auto mx-0',
    productTitle: 'text-[25px] font-[600] font-Roboto text-[#333]',
    productDiscountPrice:"font-bold text-[15px] text-[#d55b45]  font-Roboto",
    price:"font-[500] text-[10px] ] pl-3 text-[#333] line-through",
    shop_name:"pt-1 text-[15px] text-blue-400 pb-[1.5px]",
