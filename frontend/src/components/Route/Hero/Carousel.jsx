...
class Carousele extends Component {
  ...
  return (
      ...
      >
        <div>
          <img src={img1} className="h-[135px] w-[100%] rounded-[9px]  800px:h-[390px] 800px:w-[50%]" alt="" />
        </div>
        <div>
          <img src={img2} className="h-[135px] w-[100%] rounded-[9px]  800px:h-[390px] 800px:w-[50%]" alt="" />
        </div>
        <div>
          <img src={img3} className="h-[135px] w-[100%] rounded-[9px]  800px:h-[390px] 800px:w-[50%]" alt="" />
        </div>
        <div>
          <img src={img4} className="h-[135px] w-[100%] rounded-[9px]  800px:h-[390px] 800px:w-[50%]" alt="" />
        </div>
      </Carousel>
  );
};
