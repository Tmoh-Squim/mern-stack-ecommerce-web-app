...
const ProductCard = ({ data,isEvent }) => {
  ...
  return (
    <>
      <div className="w-[50%] h-[auto] mb-[0.16rem] 800px:mb-[2px] bg-white gap-x-[3px] 800px:rounded-[5px] p-[2.5px] pb-1 shadow-sm 800px:p-3  relative cursor-pointer sm:w-full">
