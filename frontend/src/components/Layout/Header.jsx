  ...
  return (
    <>
      ...
      <div
        ...
        } transition hidden 800px:flex items-center justify-between w-full bg-[springgreen] h-[70px]`}
      >
        <div
      ...
      <div
        className={`
      w-full h-[50px] fixed bg-slate-200 z-50 bottom-0 left-0 right-0 shadow-sm 800px:hidden`}
      >
